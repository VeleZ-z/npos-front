                ...
                <div key={slide.id} className="basis-full shrink-0 px-1">
                  <article className="relative overflow-hidden rounded-2xl border border-[#2a2a2a] bg-gradient-to-br from-[#1f1f1f] via-[#141414] to-[#0f0f0f] p-5 flex flex-col gap-4 min-h-[360px]">
                    <div className="relative h-44 rounded-xl overflow-hidden">
                      ...
                      />
                      {slide.badge && (
                        <span className="absolute top-3 right-3 bg-[#4BC81B] text-[#1a1a1a] text-sm font-semibold px-3 py-1 rounded-full shadow-lg">
                          {slide.badge}
                        </span>
                      )}
                    </div>
                    <div>
                      <p className="text-xs uppercase tracking-[0.3em] text-[#4BC81B]">Descuento</p>
              ...
              {limitedDiscounts.map((slide, idx) => (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all ${
                    idx === index ? "w-6 bg-[#4BC81B]" : "w-2 bg-[#555]"
                  }`}
                />
              ))}
            </div>
